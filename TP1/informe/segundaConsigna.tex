...
Las tres redes que se detallan a continuación nos hemos conectado por medio Wifi y son redes de espacios públicos sin seguridad. 
Por tal motivo cualquier dispositivo podría incorporarse a la red en cualquier momento.\\

\subsubsection{Red Wifi: laboratorioDC - FCEN}
\input{graf_laboDC}

\newpage
\subsubsection{Red Wifi: aulasDC - FCEN}
\input{graf_aulaDC}

\newpage
\subsubsection{Red Wifi: Abasto Shopping}
\input{graf_abasto}